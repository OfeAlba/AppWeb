...
public class AparcamientosPublicosDAO {
	...
	public List<AparcamientosPublicosVO> getListadoAparcamientos() throws ClassNotFoundException {
	List<AparcamientosPublicosVO> aparcamientos = new ArrayList<AparcamientosPublicosVO>();
	    ...
	    //LLAMADA A UNA QUERY
			PrimeraQuery(con);
		//LLAMADA A OTRA QUERY
			SegundaQuery(con);
		//AQUI SE USA LA LLAMADA A PROCEDIMIENTOS
			Callable(con);
		//AQUI USANDO AUTOCOMMIT
			AutoCommit(con);
		//Segunda query ahora con una inserción
	...
	public String getListadoAparcamientos(int id) throws ClassNotFoundException {
